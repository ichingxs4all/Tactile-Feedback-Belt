...
//uint16_t remote_id = 0x6E17; // set this to the ID of the remote device
...
uint16_t anchors[num_anchors] = {    0x6E4C,    0x6942,    0x6E49,     0x695B}; // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[num_anchors] = {    0,             0,      2126,       2126};            // anchor x-coorindates in mm
int32_t anchors_y[num_anchors] = {    0,          1650,         0,       1650};           // anchor y-coordinates in mm
...
void setup()
{
  ...
  //XBee.begin(57600);
  delay(2000); // A little delay for making sure the Pozyx shield has reseted
